	...
	public static void pass2(ArrayList<Line> l) {
		...
		for (int i = 0; i < l.size(); i++) {
			if (l.get(i).opcode.equalsIgnoreCase("start")) {
				...
				System.out.println(fixString(Integer.toHexString(l.get(i).address), 6)
						+ fixString(Integer.toHexString(totalLength), 6));
						...
						case 4:
							...
							default:
								...
								try {
									...
									// System.out.println(".........."+l.get(i).opcode+" "+l.get(i).operand1+"
									// "+Data.symTab.get(l.get(i).operand1).adress);
									ta = Data.symTab.get(l.get(i).operand1).adress;
								}
								break;
							}
